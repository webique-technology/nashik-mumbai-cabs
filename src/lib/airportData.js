...
export const airportToursData = [
  ...
  // ─── 1. SHIRDI AIRPORT ROUTE ───────────────────────────────────────────────
  {
    ...
    contentBlocks: [
      ...
      {
        type: "list",
        heading: "Why Choose Our Shirdi Airport Lines?",
        intro: "We specialize in flight terminal transit comfort loops:",
        items: [
          "Real-time flight status tracking alerts",
          "Zero post-landing terminal waiting structures",
          "Generous luggage cargo distribution spaces",
          "Professional highway-certified drivers",
          "Fixed pricing matrices with no hidden variables",
        ],
        closing:
          "Book your terminal transfer in advance to lock down seamless travel peace of mind.",
      },
    ],
    longDistance: {
  ...
  // ─── 2. PUNE AIRPORT ROUTE ─────────────────────────────────────────────────
  {
    ...
    contentBlocks: [
      ...
      {
        type: "list",
        heading: "Premium Service Inclusions",
        items: [
          "Chauffeur meet-and-greet right at the Pune terminal exits",
          "Flight delay accommodation buffers built-in automatically",
          "Spacious outstation vehicles suited for long-distance cruising",
    ...
    longDistance: {
      heading: "Corporate & Family Packages Available",
      content:
        "We adapt dynamically to corporate invoicing requests and custom family sightseeing stops along the way.",
  ...
  // ─── 3. MUMBAI AIRPORT ROUTE ───────────────────────────────────────────────
  {
    ...
    longDistance: {
      heading: "Book Your Advance International Transfer",
      content:
        "Coordinate your international flight timing structures directly with our reservation team for absolute pickup accuracy.",
  ...
  // ─── 5. NAGPUR AIRPORT ROUTE ───────────────────────────────────────────────
  {
    ...
    longDistance: {
      heading: "Vidarbha Corporate Packages",
      content:
        "We provide premium multi-day drop and return tracking schedules perfect for long-haul corporate needs.",
  ...
  // ─── 6. KOLHAPUR AIRPORT ROUTE ─────────────────────────────────────────────
  {
    ...
    longDistance: {
      heading: "Mahalaxmi Darshan Add-ons",
      content:
        "Optionally combine your Kolhapur airport transfer with local temple darshan stopovers seamlessly upon request.",
...
export function getAirportTourBySlug(slug) {
  if (!slug) return null;
  return airportToursData.find((t) => t.slug === slug) || null;
}

export function getAllAirportSlugs() {
