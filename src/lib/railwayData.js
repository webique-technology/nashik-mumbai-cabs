...
export const railwayToursData = [
  ...
  // ─── 12. CHHATRAPATI SAMBHAJINAGAR ROUTE ───────────────────────────────────
  {
    ...
    longDistance: {
      heading: "Combine with Heritage Sightseeing",
      content:
        "Extend your trip to include historical sightseeing tours at the nearby Ajanta or Ellora caves upon request.",
      closing: "Connect with our reservation desk now!",
    },
    meta: {
      title:
        "Chhatrapati Sambhajinagar Railway Station Cab | Outstation Station Cabs",
      description:
...
export function getRailwayTourBySlug(slug) {
  if (!slug) return null;
  return railwayToursData.find((t) => t.slug === slug) || null;
}

export function getAllRailwaySlugs() {
