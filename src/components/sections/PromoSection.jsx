                ...
                <Row className="g-0 align-items-stretch">
                    ...
                    <Col lg={6} className="text-side d-flex align-items-center">
                        <div className="content-wrapper">
                            ...
                            {desc?.map((value, i) => (
                                <p key={i} className='mb-3 text-muted'>{value}</p>
                            ))}
                                        ...
                                        return (
                                            <div key={feature.id || index} className="feature-item d-flex align-items-start mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="feature-desc text-muted mb-0 small">{feature.description}</p>
                                                </div>
                                            </div>
                                        );
                                    })}
                            ...
                            {content?.buttonText && (
                                ...
                                >
                                    {content.buttonText} <span className="arrow-icon">&rarr;</span>
                                </button>
                            )}
                        </div>
                    </Col>
...
const AppDownloadBanner = ({
    ...
    return (
        ...
        >
            {/* Background shapes can be added manually via CSS overlay */}
            ...
            <Container>
                <Row className="align-items-center g-4 g-md-0">
                    ...
                    <Col md={7} sm={12} className="text-content-col position-relative z-1">
                        <h2 className="banner-heading text-white fw-bold mb-4">
                            {titlePrefix} <span className="highlight-text">{titleHighlight}</span> {titleSuffix}
                        </h2>
                    ...
                    {/* Right Side: Double Mobile Mockup Single Image Asset */}
                    <Col md={5} sm={12} className="mockup-display-col position-relative d-flex align-items-end justify-content-center">
                        <div className="mockup-img-wrapper">
                            {typeof mockupImageSrc === 'object' && mockupImageSrc.src ? (
                                // Safe check if you're directly passing a static Next.js Image asset import
                                <Image
                                    src={mockupImageSrc}
                                ...
                                // Support normal string asset URLs
                                <img
                                    src={mockupImageSrc}
                                    alt="App Mobile Mockups"
                                    className="double-mockup-img img-fluid"
...
AppDownloadBanner.propTypes = {
    ...
    mockupImageSrc: PropTypes.oneOfType([PropTypes.string, PropTypes.object]).isRequired,
};
