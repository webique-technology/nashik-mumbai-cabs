...
export const FaqSec = () => {
  const faqData = [
    {
      quest: "Can I get a refund ticket ?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "My Discount Code is not Working, What do I do?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "What Destinations Do You Specialize In?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "What is Your Cancellation Policy?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "What travel documents do I need?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "Do You Offer Travel Insurance?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "How many People can stay in the Hotel?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
    {
      quest: "How to extend the support?",
      ans: "Metus vulputate eu scelerisque felis imperdiet. At in tellus integer feugiat scelerisque varius morbi enim nunc.",
    },
  ];
